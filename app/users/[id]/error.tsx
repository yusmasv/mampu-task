...
export default function Error({
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10">
      ...
      <div className="flex flex-col items-center gap-4 rounded-2xl border border-red-200 bg-red-50 px-8 py-14 text-center dark:border-red-900/60 dark:bg-red-950/40">
        <div className="flex h-14 w-14 items-center justify-center rounded-full bg-red-100 dark:bg-red-900/50">
          <svg className="h-7 w-7 text-red-500 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
